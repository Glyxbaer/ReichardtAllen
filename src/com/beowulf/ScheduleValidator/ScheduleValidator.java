...
public class ScheduleValidator
{
    ...
    public static void main(String[] args)
    {
        ...
        FileParser myParser = new FileParser(new File("conf\\constraints.conf"), new File("conf\\definitions.conf"));
        ...
        {
            System.out.println("Timetable is NOT consistent, please check your definitions file on consistency");
        }
