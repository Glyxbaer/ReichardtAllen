                ...
                {   
                    ...
                    {   
                        ...
                        errorMessages.add("[Conflict] The constraint says: " + rel.getX1().getName() + ", " + rel.getX1().getProf() + " " + rel.getX1().getCourse()
                                + myConstraintNetwork.getConstraintStringFromConstraintShort(vektor) + " " + rel.getX2().getName() + ", " + rel.getX2().getProf()+ " " + rel.getX2().getCourse());
                    ...
                    for (Relation r : rels)
                    {
                        if ((r.getX1().getId() == l1.getId() || r.getX1().getId() == l2.getId()) && (r.getX2().getId() == l1.getId() || r.getX2().getId() == l2.getId()))
                        {
                            for (Short constraint : r.getCons())
                            {
                                ...
                                if (constraint == ConstraintNetwork.bin_during || constraint == ConstraintNetwork.bin_contains)
                                    valid = true;
                            }
                        }
                    }
